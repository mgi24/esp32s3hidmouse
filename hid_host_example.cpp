...
void app_main(void)
{
    ...
    if (Ethernet.begin(mac) == 0) {
        Serial1.println("Gagal memulai Ethernet. Periksa koneksi HSPI.");
    }
    if (Ethernet.hardwareStatus() == EthernetNoHardware) {
        Serial1.println("Tidak ada perangkat Ethernet yang terdeteksi.");
    } else if (Ethernet.hardwareStatus() == EthernetW5100) {
        Serial1.println("W5100 terdeteksi.");
    }
    server.begin();
